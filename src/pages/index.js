    ...
    <Layout>
        ...
        <div class="m-2">
          <Link to="/places">
            <button class="bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded transition duration-300">
              Visit Places
              <div class="text-xs">Explore popular destinations in Japan</div>
            </button>
          </Link>
        </div>
        <div class="m-2">
          <Link to="/kanjis">
            <button class="bg-green-500 hover:bg-green-600 text-white font-bold py-2 px-4 rounded transition duration-300">
              Helpful Kanji
              <div class="text-xs">Learn useful Kanji for your trip</div>
            </button>
          </Link>
        </div>
      </div>
      ...
      <div class="grid grid-cols-1 lg:grid-cols-3 lg:gap-6">
        <div className="flex flex-row items-start mb-4 lg:mb-0 mx-4">
          ...
          <div>
            <h3 class="text-lg font-semibold">Gatsby (Jamstack)</h3>
            <p class="text-sm">
        ...
        <div className="flex flex-row items-start mb-4 lg:mb-0 mx-4">
          ...
          <div>
            <h3 class="text-lg font-semibold">CI/CD via Netlify</h3>
            <p class="text-sm">
        ...
        <div className="flex flex-row items-start mb-4 lg:mb-0 mx-4">
          ...
          <div>
            <h3 class="text-lg font-semibold">Google Maps Embed API</h3>
            <p class="text-sm">
        ...
        <div className="mr-4 flex-shrink-0">
          ...
          <div>
          <h3 class="text-lg font-semibold">GraphQL for data querying</h3>
            <p class="text-sm">
        ...
        <div className="flex flex-row items-start mb-4 lg:mb-0 mx-4">
          ...
          <div>
            <h3 class="text-lg font-semibold">Markdown (MDX) for content</h3>
            <p class="text-sm">
